...
For this project, you can start with a spam/ham dataset, then predict the class of new documents (either withheld from the training 
...
pathname <- "C:/Users/user/Desktop/project 4"
```
